...
# ============================================================
# D04B — PennFudan ViT-B/16 dense — part 2 of 2
...
# ============================================================
# 6. Restore previous D04B results if attached
# ============================================================
echo
echo "============================================================"
echo "6. RESTORE PREVIOUS D04B RESULTS IF AVAILABLE"
echo "============================================================"
...
if not archives:
    print("No previous D04B ZIP found; starting fresh.")
    raise SystemExit(0)
...
echo
echo "============================================================"
echo "9. BUILD D04B EXECUTION PLAN"
echo "============================================================"
...
if (( RUN_RC == 124 )); then
    echo "D04B INCOMPLETE ONLY BECAUSE OF KAGGLE TIME LIMIT."
    echo "Attach D04B_results.zip and rerun this same cell."
...
echo "D04B FAILED WITH A REAL TRAINING ERROR."
