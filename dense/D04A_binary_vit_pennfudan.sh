...
# ============================================================
# D04A — PennFudan ViT-B/16 dense — part 1 of 2
# CORRECTED STANDALONE KAGGLE CELL
# ============================================================

SESSION_ID="D04A"
TARGET="binary_vit_pennfudan"
...
# ============================================================
# Helper: package completed/partial results
# ============================================================
pack_results() {
...
#
# The old loader compared stems literally and therefore found
...
if already_fixed:
    ...
    if old not in text:
        raise RuntimeError(
            "Expected PennFudan pairing code was not found. "
...
# ============================================================
# 6. Restore previous D04A results if attached
# ============================================================
echo
echo "============================================================"
echo "6. RESTORE PREVIOUS D04A RESULTS IF AVAILABLE"
echo "============================================================"
...
if not archives:
    print("No previous D04A ZIP found; starting fresh.")
    raise SystemExit(0)
...
# ============================================================
# 7. Download PennFudan + ViT-B/16 pretrained weights
# ============================================================
echo
echo "============================================================"
echo "7. PRELOAD PENNFUDAN + PRETRAINED VIT-B/16"
echo "============================================================"
...
# ============================================================
# 8. Validate real PennFudan data through repository loader
# ============================================================
echo
echo "============================================================"
...
echo
echo "============================================================"
echo "9. BUILD D04A EXECUTION PLAN"
echo "============================================================"
...
status_file = root / "SESSION_STATUS.json"
...
path = Path(os.environ["OUTPUT_ROOT"]) / "SESSION_STATUS.json"
status = json.loads(path.read_text())

print("true" if status["complete"] else "false")
PY
)"
...
if (( RUN_RC == 124 )); then
    echo "D04A INCOMPLETE ONLY BECAUSE OF KAGGLE TIME LIMIT."
    echo "Attach D04A_results.zip and rerun this same cell."
...
echo "D04A FAILED WITH A REAL TRAINING ERROR."
